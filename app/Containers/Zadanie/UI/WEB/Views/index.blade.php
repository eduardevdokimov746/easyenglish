        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table class="table-hover table-list-zadanie" border="1">
                    ...
                    <tr class="table-info table-row" data-href="{{ route('web_zadanie_show', 'asd') }}">
                        <td>1</td>
                    ...
                    <tr class="table-warning table-row" data-href="{{ route('web_zadanie_show', 'asd') }}">
                        <td>1</td>
                        <td>Иванова Ивановна</td>
                        <td>Перевод</td>
                        <td>20.12.2020</td>
                    ...
                    <tr class="table-success table-row" data-href="{{ route('web_zadanie_show', 'asd') }}">
                        <td>1</td>
                        <td>Иванова Ивановна</td>
                        <td>Перевод</td>
                        <td>20.12.2020</td>
                    ...
                    <tr class="table-danger table-row" data-href="{{ route('web_zadanie_show', 'asd') }}">
                        <td>1</td>
                        <td>Иванова Ивановна</td>
                        <td>Перевод</td>
                        <td>20.12.2020</td>
