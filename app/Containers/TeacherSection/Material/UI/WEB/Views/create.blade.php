...
@section('content')
    <section class="other_services pt-5" id="why">
        <div class="container mb-4">
                            ...
                            <div class="col-lg-4 box-text mt-3" style="margin-bottom: 0">
                                <div class="grid">
                                    <div class="box-text-stat-div">
                                        <img src="{{ asset('storage/materials/no-image-material.png') }}" alt="" class="img-fluid">
                                    </div>
                                    <div class="info p-4">
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary" :disabled="isActiveAddMaterialBtn" @click="addMaterial">Создать</button>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        var dictionaryComponent = {
            data:{
                ...
                htmlTitle: "{!! isset($isPrepare) ?  htmlspecialchars($htmlTitle) : '' !!}",
                htmlText: "{!! isset($isPrepare) ? htmlspecialchars($htmlText) : '' !!}",
                htmlTitleToDb: "{!! isset($isPrepare) ? htmlspecialchars($htmlTitleToDb) : '' !!}",
                htmlTextToDb: "{!! isset($isPrepare) ? htmlspecialchars($htmlTextToDb) : '' !!}",
                newWords: [],
                isPrepare: "{!! isset($isPrepare) !!}" ? true : false,
                isLoadImage: false,
                image: {},
                complexity: 'default',
                is_visible: false
            ...
            methods:{
                ...
                addMaterial: function() {
                    ...
                    console.log('asd');
                    $.ajax({
                        url: '{{ route('web_teacher_materials_store') }}',
                        type: 'post',
                        data: form,
                        processData: false,
                        contentType: false,
        ...
        $(document).ready(function(){
            var defaultImage = '{{ asset('storage/materials/no-image-material.png') }}';
