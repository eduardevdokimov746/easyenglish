                ...
                <div class="col-md-9">
                    <div class="form form-create-course">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description_zadanie" class="ckeditor-textarea" name="description"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="links_section">Прикрепленные ссылки</label>
                            <div>
                                <div class="div-link-change-section" v-for="(link, indexLink) in links">
                                    ...
                                    <div class="input-group mb-3" style="width: 95%">
                                        ...
                                        <input type="text" class="form-control" placeholder="yandex.ru" @keyup="replaceUrl($event, indexLink)" v-model="link.url">
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="last-datetime-send">Крайний срок сдачи <span class="mark-required-field" title="Обязательно для заполнения">*</span></label>
                            <input type="datetime-local" v-model="deadline" id="last-datetime-send">
                        </div>

                        <div class="form-check">
                            <input v-model="isPublished" type="checkbox" class="form-check-input" id="check-isPublish-zadanie">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <button class="btn btn-primary" @click="submitBtn" :disabled="isActiveBtn">Создать</button>
                    </div>
                </div>
        ...
        var createZadanieComponent = {
            ...
            methods: {
                ...
                submitBtn: function(){
                    ...
                    $.ajax({
                        url: '{{ route('web_teacher_zadanies_store') }}',
                        processData: false,
                        contentType: false,
                        data: form,
                        type: 'post',
