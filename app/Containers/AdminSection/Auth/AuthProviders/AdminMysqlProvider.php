...
namespace App\Containers\AdminSection\Auth\AuthProviders;
...
class AdminMysqlProvider implements UserProvider
{
    use AuthenticableDataFromSession;

    public function retrieveById($identifier)
    {
        $user = User::where('login', $identifier)->where('role', 'admin')->with('email')->first();
